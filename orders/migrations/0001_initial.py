    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='company.delivery', verbose_name='Вид доставки')),
                ('payment', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='company.payment', verbose_name='Способ оплаты')),
                ...
                ('weight', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='company.weight', verbose_name='Вес')),
            ],
            options={
                'verbose_name': 'Заказ',
